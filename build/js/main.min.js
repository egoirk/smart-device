...
/* ACCORDION*/
var accordionList = document.querySelectorAll('.accordion-item');
accordionList.forEach(function (event) {
  return event.addEventListener('click', function () {
    if (event.classList.contains('accordion-active', 'accordion-open')) {
      event.classList.remove('accordion-active', 'accordion-open');
    } else {
      accordionList.forEach(function (event2) {
        return event2.classList.remove('accordion-active', 'accordion-open');
      });
...
var textButton = document.querySelector('.about__button');
var textHidden = document.querySelector('.content__hidden');
